...
export const ContributeView = () => {
  const description = 'If you work in a 4-day week company or would like to suggest one to be added to the list, you can contribute to this project filling a Google Form or opening a pull request on Github.';
  return (
